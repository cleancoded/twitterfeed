...
Description: Show Twitter feed from multiple users/screens/hashtags
Author: James
Version: 1.0
...
class Tweet_Widget extends WP_Widget
{
    ...
    public function form($instance)
    {
        ...
        <p><label for='<?php echo $this->get_field_id("twitter_consumer_key"); ?>'>
            <?php esc_attr_e("Twitter Consumer Key:", "james");?>
        ...
        <label for='<?php echo $this->get_field_id("twitter_consumer_secret"); ?>'>
            ...
            <input esc_attr type="text" class="widefat" name="<?php echo $this->get_field_name('twitter_consumer_secret'); ?>" id="<?php echo $this->get_field_id('twitter_consumer_secret'); ?>" value="<?php echo $values['twitter_consumer_secret']; ?>" />

        </label>
        <label for='<?php echo $this->get_field_id("twitter_access_token"); ?>'>
            <?php esc_attr_e("Twitter Access Token:", "james");?>
        ...
        <label for='<?php echo $this->get_field_id("twitter_access_token_secret"); ?>'>
            <?php esc_attr_e("Tiwtter Access Token Sceret:", "james");?>
        ...
        <label for='<?php echo $this->get_field_id("title"); ?>'>
            <?php esc_attr_e("Widget Title:", "james");?>
        ...
        <label for='<?php echo $this->get_field_id("query"); ?>'>
            <?php esc_attr_e("Users (Enter comma, seperated list)");?>
        ...
        <label for='<?php echo $this->get_field_id("count"); ?>'>
            <?php esc_attr_e("Number of tweets to display");?>
            <input type="text" class="widefat" name="<?php echo $this->get_field_name('count'); ?>" id="<?php echo $this->get_field_id('count'); ?>" value="<?php echo $values['count']; ?>" />

        </label>
        <label for='<?php echo $this->get_field_id("replies"); ?>'>
            <?php esc_attr_e("Exclude Replies - Enter true or false");?>
            <input type="text" class="widefat" name="<?php echo $this->get_field_name('replies'); ?>" id="<?php echo $this->get_field_id('replies'); ?>" value="<?php echo $values['replies']; ?>" />
    ...
    public function update($new_instance, $old_instance)
    {
        ...
        $instance['replies']                     = !empty($new_instance['replies']) ? $new_instance['replies'] : "";
        return $instance;
    }
    ...
    public function retrieve_tweets($widget_id, $instance)
    {
        ...
        $tweets_list = $this->james_tweets_lib->get("search/tweets", ["q" => $query_string, "count" => $instance['count'], "exclude_replies" => $instance['replies']]);
        return $tweets_list;
    }
...
//register the widget
add_action("widgets_init", function () {register_widget("Tweet_Widget");});